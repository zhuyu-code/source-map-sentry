...
export default observer(()=>{
  const content=(<a className="loginout" onClick={loginout}>退出登录</a>)
  function loginout(){
    localStorage.clear();
    history.push('/home')
  }
    ...
    <div>
      <div className="home-header">
        ...
        <ul>
          ...
          <li><a>文档</a></li>
          <li><a>博客</a></li>
          <li><Link to="/product">控制台</Link></li>
          {
            localStorage.getItem("userInfo")?
            <li>
                <a>
                <Popover placement="bottomLeft" title={JSON.parse(localStorage.getItem("userInfo")).userName} content={content} trigger="click">
                <Avatar
      ...
      <div className="home-content">
        <div className="home-content_left">
          ...
          <p className="home-content_left_p2">简洁、高效的 Bug 追踪，轻量、便捷的项目管理，安全、稳定的数据保障，完美地将 Bug管理与团队协作结合在一起。项目管理，本就是一种优雅的艺术</p>
          <p className="home-content_left_p3">累计处理错误<span>31115</span></p>
        </div>
